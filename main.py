...
filecsvujicoba = "C:\\Users\\qitma\\Dropbox\\Tugas Akhir\\Dataset\\Data Twitter\\Praproses\\Qitma\\uji_coba2.csv"
...
textAnalyze.import_file_train_to_object(fileName=filecsvujicoba)
...
# textAnalyze.naive_bayes_classification(textAnalyze.list_of_train_tweet)
# textAnalyze.test_data(fileTest=filecsvtest,fileEmoticon=fileEmoticon,negationWord=negation_word,stopWord=stop)
# textAnalyze.print_test_tweet(textAnalyze.list_of_test_tweet)
